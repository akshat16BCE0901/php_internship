				...
				<div class="bs-example table-responsive widget-shadow" data-example-id="bordered-table"> 
					...
					<div align="center" class="text-center allcat">
						<?php 
							...
							echo "class=' pgnum btn btn-primary btn-sm' golink='adminadminpanel.php?page=1&subpage=$pageno1'>First</button>
								  <button ";
							if($pageno==1)
							{
								echo "disabled ";
							}
							echo "class=' pgnum btn btn-primary btn-sm' golink='adminadminpanel.php?page=";
							$pageno-=1;
							echo "$pageno&subpage=$pageno1'>Prev</button>
								  <button  ";
								  $pageno+=1;
							if($pageno==$num_row)
							{
							...
							echo " class=' pgnum btn btn-primary btn-sm' golink='adminadminpanel.php?page=";
							$pageno+=1;
							echo "$pageno&subpage=$pageno1'>Next</button>
								  <button  ";
								  $pageno-=1;
							if($pageno==$num_row)
							{
							...
							echo "class=' pgnum btn btn-primary btn-sm' golink='adminadminpanel.php?page=$num_row&subpage=$pageno1'>Last</button>";
				...
				<div class="bs-example table-responsive widget-shadow" data-example-id="bordered-table"> 
					...
					<div align="center" class="text-center allsubcat">
						<?php 
							...
							echo "class=' pgnum1 btn btn-primary btn-sm' golink='adminadminpanel.php?page=$pageno&subpage=1'>First</button>
								  <button ";
							if($pageno1==1)
							{
								echo "disabled ";
							}
							echo "class=' pgnum1 btn btn-primary btn-sm' golink='adminadminpanel.php?page=";
							$pageno1-=1;
							echo "$pageno&subpage=$pageno1'>Prev</button>
								  <button  ";
								  $pageno1+=1;
							...
							echo "class=' pgnum1 btn btn-primary btn-sm' golink='adminadminpanel.php?page=$pageno&subpage=$num_row1'>Last</button>";
		...
		$(".pgnum").click(function()
		{
			...
			$.ajax({
		            ...
		            success : function(data)
		            {
		              ...
		              $(".toggleallsubcat").html("+");
		              $(".alladdsubcat").hide();
		              $(".togglealladdsubcat").html("+");
		              $(".alladdmaincat").hide();
		              $(".togglealladdmaincat").html("+");
		            }
