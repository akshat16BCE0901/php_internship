...
<html>
<head>
<title>Admin Panel | <?php echo $_SESSION['user']; ?></title>
...
<script async defer crossorigin="anonymous" src="https://connect.facebook.net/en_US/sdk.js#xfbml=1&version=v3.3"></script>
	...
	<?php include 'sidebar.php'; ?>
						...
						<li class="dropdown profile_details_drop">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
								<div class="profile_img">	
									<span class="prfil-img"><img width="40.89px" height="40.89px" src="../assets/images/profiles/<?php echo $_SESSION['user'] ?>.png" alt=""> </span> 
									<div class="user-name">
		...
		<!-- main content start-->
	<div id="page-wrapper">
		<?php include 'adminmaincontent.php'; ?>
	</div>
	<!--footer-->
	<div class="footer">
	   <p>Copyright &copy; Akshat singhal ,2019</p>		
	</div>
    <!--//footer-->
	</div>
